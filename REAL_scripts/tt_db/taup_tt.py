...
build_taup_model("ghana.nd",output_folder="/home/shazam/anaconda3/envs/IPIML/lib/python3.9/site-packages/obspy/taup/data/", verbose=False)
model = TauPyModel(model="ghana")
# model = TauPyModel(model="ak135")

with open("ttdb6.txt", "w") as f:
